...
//
//Orginal Author: Adi Reddy Mora

/*****Updated Class to create GUID of specified length*****/

/**Usage


trace(GUID.create(40));
Make a call to create method with argument of length;
...
package gs {
	...
	public class GUID {
		...
		public function create( len:Number ):String {
			len >40 ?len=40:true;
			...
			var id3:String = "testing";
			
			var guid:String = calculate(id1+id3+id2+counter++).toUpperCase();
			return guid.substr(1,len);
		}
